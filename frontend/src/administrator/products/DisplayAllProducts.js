...
const handleEditProduct=async()=>{
    ...
    if(validation())
    {
        var body={productid:productId,productname:productName,categoryid:categoryId,subcategoryid:subCategoryId,description:description,status:status}
...
const showProductForm=()=>{
    ...
    <Grid item xs={6}>
        <Button onClick={handleEditProduct} fullWidth variant="contained" color="success">Edit</Button>
    </Grid>
    <Grid item xs={6}>
        <Button onClick={handleProductDelete} fullWidth variant="contained" color="error">Delete</Button>
    </Grid>
    </Grid>
